...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.az, request.aO, true);
		} catch (e) {
...
var $author$project$Main$Model = F2(
	function (hover, previews) {
		return {z: hover, K: previews};
	});
...
var $author$project$Main$GotPreviews = function (a) {
	return {$: 4, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{ao: false, aq: r.aq, at: r.at, av: r.av, az: r.az, aK: r.aK, aM: r.aM, aO: r.aO}));
};
		...
		switch (msg.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$author$project$Main$GotPreviews,
						$elm$core$Task$sequence(
							A2(
								$elm$core$List$map,
								$elm$file$File$toUrl,
					...
					$elm$http$Http$request(
						{
							aq: A2(
								...
								'application/json',
								'{\"jsonrpc\": \"2.0\", \"method\": \"set_img\", \"id\": 1, \"params\": [\"' + (A2($elm$core$String$join, '|', urls) + '\" ] }')),
							at: $elm$http$Http$expectWhatever($author$project$Main$Uploaded),
							av: _List_Nil,
							az: 'POST',
							aK: $elm$core$Maybe$Nothing,
							aM: $elm$core$Maybe$Just('upload'),
							aO: '/api'
						}));
			default:
				var result = msg.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Main$viewPreview, model.K))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{ay: $author$project$Main$init, aJ: $author$project$Main$subscriptions, aN: $author$project$Main$update, aP: $author$project$Main$view});
